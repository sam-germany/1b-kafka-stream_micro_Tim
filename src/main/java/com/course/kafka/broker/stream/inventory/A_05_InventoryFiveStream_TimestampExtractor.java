...
//@Configuration
public class A_05_InventoryFiveStream_TimestampExtractor {
   ...
   KStream<String, InventoryMessage> inventoryStream = builder.stream("t.commodity.inventory",
        ...
        inventoryStream
                ...
                .groupByKey()
                .windowedBy(TimeWindows.of(windowLength22))
...
/*
(1)
builder.stream(... , ... , new new InventoryTimestampExtractor22(), null)
