...
// video 121
//@Configuration
public class A_01_PremiumOfferOneStream_InnerJoin {
    ...
    public KStream<String, PremiumOfferMessage> kstreamPremiumOffer(StreamsBuilder builder) {
        ...
        var offerStream = purchaseStream.join(userTable, this::joiner22, Joined.with(stringSerde, purchaseSerde, userSerde));
