...
// video 114
//@Configuration
public class A_01_OrderPaymentOneStream_Inner_Join {
 ...
 var paymentStream22 = builder.stream("t.commodity.online-payment",
        ...
        // join
        orderStream11.join( paymentStream22,
...
(2)
rest is eady to understand that first we are fetching the data from 2 different topics and after that joining the data
