...
public class OnlinePaymentTimestampExtractor22 implements TimestampExtractor {
    ...
    public long extract(ConsumerRecord<Object, Object> record, long partitionTime) {
        ...
        return onlinePaymentMessage != null ?
                LocalDateTimeUtil22.toEpochTimestamp22(onlinePaymentMessage.getPaymentDateTime()) : record.timestamp();
    }
}
/*
